...
program
  ...
  .option(
    "-f, --fontName [fontName]",
    "fontFamily name in css, default: iconfont"
  )
  .option(
    "-F --fontFileName [fontFileName]",
    "filename of output file, default: iconfont"
  )
  .option("-p --cssPrefix [cssPrefix]", "css classname prefix, default: icon")
  .option(
    "-C --className [className]",
    "classname of common class for icon, default: iconfont"
  )
  .option(
    "-o --output [output]",
    "the dest directory of output file, default: fonts"
  )
  .option(
    "-s --svgsPath [svgsPath]",
    "the svgs source directory, default: svgs"
  )
  .option(
    "-u --startUnicode [startUnicode]",
    "the start unicode of icons, default: \uE600"
  )
